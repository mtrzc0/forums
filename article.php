...
<head>
    ...
    <script src="/forums/js/article.js" defer></script>
                    ...
                    try {
                        ...
                        try {
                            ...
                            if ($sql_stmt->execute()) {
                                $row = $sql_stmt->fetch();
                    ?>
                                <div class="article-post-main-element">
                                    <div class="article-post-data">
                                        <img class="article-post-user-img" src="/forums/img/user-avatar.png">
                                        <div class="article-post-user-info">
                                            <span class="article-post-header">
                                                Posted by
                                            </span> <span class="article-post-user-login"><?php echo $row['login'] ?> </span><span class="article-post-header"> <?php echo toTime($row['date']) ?> </span>
                                        </div>
                                        <?php
                                        if (isset($_SESSION['isLogged']) && $_SESSION['login'] === $row['login']) {
                                            printf('
                                                <div class="article-post-edit">
                                                    <a href="/forums/edit-post.php?id=%s"><i class="far fa-edit"></i> &nbsp; Edit</a>
                                                </div>', $_SESSION['post_id']);
                                        }
                                        ?>
                                    </div>
                                    <h5 class="article-post-title"> <?php echo $row['title'] ?><span class="article-post-cat"><?php echo $row['category'] ?></span> </h5>
                                    <div class="article-post-content"> <?php echo $row['content'] ?> </div>
                                    <div class="article-post-buttons">
                                        <div class="article-post-button-arrow-up">
                                            <a href="#"> <i class="fas fa-chevron-up"></i> &nbsp; <?php echo $row['votes'] ?> </a>
                                        </div>
                                        <div class="article-post-button-comment">
                                            <a href="#new-comment-anchor"> <i class="fas fa-comment-alt"></i> &nbsp; <?php echo printComment($row['comments']) ?> </a>
                                        </div>
                                        <div class="article-post-button-share">
                                            <a>
                        ...
                        <?php if (isset($_SESSION['isLogged']) && $_SESSION['isLogged']):?>
                            <div class="new-comment-main-element" id="new-comment-anchor">
                                ...
                                <form action="server/create-new-comment.php" method="POST" autocomplete="off">
                                    <div class="new-comment-content">
                                        <textarea class="new-comment-text" name="new-comment-data-text" cols="30" rows="5" placeholder="What you mean?"></textarea>
                                    </div>
                        <?php
